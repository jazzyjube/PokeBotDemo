...
public class PokemonCatchCellTest {
    ...
    @Test
    public void testCatchAnswerNo() throws TwitterException {
    ...
    public void testCatchAnswer() throws TwitterException {
    	Tweet tweet = new Tweet("maitre_peter", "@dialga_shiny Pokeball !!");
        assertEquals("@maitre_peter @maitre_peter is my new owner !!! #PokeBattle", cell.ask(tweet));
    }
